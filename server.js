...
app.post("/analyze", (req, res) => {
  ...
  const curiosityGap =
    text.includes("Nobody") || text.includes("Why")
      ? 89
      : 68;

  const clarity =
    text.length < 1200 ? 90 : 71;
  ...
  if (ctaStrength < 70)
    recommendation = "Add a stronger engagement question.";

  if (hookStrength < 80)
    recommendation = "Strengthen the opening hook.";
